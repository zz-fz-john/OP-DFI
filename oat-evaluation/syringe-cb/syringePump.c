...
/* -- Default Parameters -- */
float __attribute__((annotate("nova_sensitive_var"))) mLBolus = 0.500; //default bolus size
float __attribute__((annotate("nova_sensitive_var"))) mLBigBolus = 1.000; //default large bolus size
float __attribute__((annotate("nova_sensitive_var"))) mLUsed = 0.0;
int __attribute__((annotate("nova_sensitive_var"))) mLBolusStepIdx = 3; //0.05 mL increments at first
//float mLBolusStep = mLBolusSteps[mLBolusStepIdx];
float __attribute__((annotate("nova_sensitive_var"))) mLBolusStep = 0.050;
...
//serial
char __attribute__((annotate("nova_sensitive_var"))) serialStr[80] = "";
boolean __attribute__((annotate("nova_sensitive_var"))) serialStrReady = false;
int __attribute__((annotate("nova_sensitive_var"))) serialStrLen = 0;
...
void  __attribute__((annotate("critical function"))) processSerial(){
