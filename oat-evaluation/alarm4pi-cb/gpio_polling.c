...
void* polling_thread(volatile int *exit_polling)
  {
   int __attribute__((annotate("nova_sensitive_var"))) ret_err;
   int __attribute__((annotate("nova_sensitive_var"))) read_err;
   int __attribute__((annotate("nova_sensitive_var"))) curr_pir_value;
   int __attribute__((annotate("nova_sensitive_var"))) last_pir_value;
   int __attribute__((annotate("nova_sensitive_var"))) pir_perman_counter;
...
int __attribute__((annotate("critical function"))) init_polling(volatile int *exit_polling, char *msg_info_fmt)
  {
   int __attribute__((annotate("nova_sensitive_var"))) ret_err;
