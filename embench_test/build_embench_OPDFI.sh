...
/home/zrz0517/study/chain_attestation/OP-DFI/toolchain/llvm-project/build/bin/llvm-link \
    ...
    -o src/"$1"/"$1".bc
/home/zrz0517/study/chain_attestation/OP-DFI/toolchain/llvm-project/build/bin/llvm-dis src/"$1"/"$1".bc -o src/"$1"/"$1".ll
...
/home/zrz0517/study/chain_attestation/OP-DFI/toolchain/llvm-project/build/bin/llvm-dis src/"$1"/test_combo_after_dfi.bc -o src/"$1"/test_combo_after_dfi.ll
...
scp -P 1717 ./dfi_log.txt src/"$1"/"$1"_opdfi pi@10.204.20.129:/home/pi 
cd ../