...
python3 add_data_base.py  ../output/"$1"_rewrite ../output/final_hash_database_single_on_server_"$1".txt .custom_ro_data
...
cp ../output/"$1"_rewrite ${ROOT_DIR}/embench_test/bd/src/"$1"/
