; ModuleID = './output/data_flow_test_after_dfi.bc'
...
entry:
  ...
  call void @opdfi_dfi_store_taint(i32 0, i32* %n.addr)
  call void @opdfi_sandbox_store_check(i32 1, i32* %n.addr)
  store i32 %n, i32* %n.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %n.addr, metadata !38, metadata !DIExpression()), !dbg !39
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8**)*)(i32 1, i8** %param.addr)
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8**)*)(i32 1, i8** %param.addr)
  ...
  call void @opdfi_dfi_load_checked(i32 2, i32* %n.addr), !dbg !42
  call void @opdfi_sandbox_load_check(i32 1, i32* %n.addr), !dbg !42
  %0 = load i32, i32* %n.addr, align 4, !dbg !42
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 3, i8** %param.addr), !dbg !43
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %param.addr), !dbg !43
...
cond.true:                                        ; preds = %entry
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 4, i8** %param.addr), !dbg !44
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %param.addr), !dbg !44
  %2 = load i8*, i8** %param.addr, align 4, !dbg !44
  br label %cond.end, !dbg !43

cond.false:                                       ; preds = %entry
  %3 = getelementptr inbounds [7 x i8], [7 x i8]* @.str.1, i32 0, i32 0
  br label %cond.end, !dbg !43

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i8* [ %2, %cond.true ], [ %3, %cond.false ], !dbg !43
  %4 = getelementptr inbounds [44 x i8], [44 x i8]* @.str, i32 0, i32 0
  %call = call i32 (i8*, ...) @printf(i8* %4, i32 %0, i8* %cond), !dbg !45
  ret i32 0, !dbg !46
}
...
entry:
  ...
  call void @opdfi_dfi_store_taint(i32 9, i32* %op.addr)
  call void @opdfi_sandbox_store_check(i32 1, i32* %op.addr)
  store i32 %op, i32* %op.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %op.addr, metadata !51, metadata !DIExpression()), !dbg !52
  call void @opdfi_dfi_load_checked(i32 10, i32* %op.addr), !dbg !53
  call void @opdfi_sandbox_load_check(i32 1, i32* %op.addr), !dbg !53
...
entry:
  ...
  call void @opdfi_dfi_store_taint(i32 11, i32* %st.addr)
  call void @opdfi_sandbox_store_check(i32 1, i32* %st.addr)
  store i32 %st, i32* %st.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %st.addr, metadata !58, metadata !DIExpression()), !dbg !59
  call void @opdfi_dfi_load_checked(i32 12, i32* %st.addr), !dbg !60
  call void @opdfi_sandbox_load_check(i32 1, i32* %st.addr), !dbg !60
...
entry:
  ...
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8**)*)(i32 13, i8** %filename.addr)
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8**)*)(i32 1, i8** %filename.addr)
  ...
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8**)*)(i32 14, i8** %buffer.addr)
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8**)*)(i32 1, i8** %buffer.addr)
  ...
  call void @opdfi_dfi_store_taint(i32 15, i32* %buffer_size.addr)
  call void @opdfi_sandbox_store_check(i32 1, i32* %buffer_size.addr)
  ...
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 16, i8** %filename.addr), !dbg !136
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %filename.addr), !dbg !136
  %0 = load i8*, i8** %filename.addr, align 4, !dbg !136
  %1 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.2, i32 0, i32 0
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* %1), !dbg !137
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, %struct._IO_FILE**)*)(i32 17, %struct._IO_FILE** %file), !dbg !135
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, %struct._IO_FILE**)*)(i32 1, %struct._IO_FILE** %file), !dbg !135
  ...
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 18, i8** %buffer.addr), !dbg !140
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %buffer.addr), !dbg !140
  %2 = load i8*, i8** %buffer.addr, align 4, !dbg !140
  call void @opdfi_dfi_load_checked(i32 19, i32* %buffer_size.addr), !dbg !141
  call void @opdfi_sandbox_load_check(i32 1, i32* %buffer_size.addr), !dbg !141
  %3 = load i32, i32* %buffer_size.addr, align 4, !dbg !141
  %sub = sub i32 %3, 1, !dbg !142
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct._IO_FILE**)*)(i32 20, %struct._IO_FILE** %file), !dbg !143
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct._IO_FILE**)*)(i32 1, %struct._IO_FILE** %file), !dbg !143
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** %file, align 4, !dbg !143
  %call1 = call i32 @fread(i8* %2, i32 1, i32 %sub, %struct._IO_FILE* %4), !dbg !144
  call void @opdfi_dfi_store_taint(i32 21, i32* %bytes_read), !dbg !139
  call void @opdfi_sandbox_store_check(i32 1, i32* %bytes_read), !dbg !139
  store i32 %call1, i32* %bytes_read, align 4, !dbg !139
  call void @opdfi_dfi_load_checked(i32 22, i32* %bytes_read), !dbg !145
  call void @opdfi_sandbox_load_check(i32 1, i32* %bytes_read), !dbg !145
  %5 = load i32, i32* %bytes_read, align 4, !dbg !145
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 23, i8** %filename.addr), !dbg !146
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %filename.addr), !dbg !146
  %6 = load i8*, i8** %filename.addr, align 4, !dbg !146
  %7 = getelementptr inbounds [24 x i8], [24 x i8]* @.str.3, i32 0, i32 0
  %call2 = call i32 (i8*, ...) @printf(i8* %7, i32 %5, i8* %6), !dbg !147
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 24, i8** %buffer.addr), !dbg !148
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %buffer.addr), !dbg !148
  %8 = load i8*, i8** %buffer.addr, align 4, !dbg !148
  %arrayidx = getelementptr inbounds i8, i8* %8, i32 0, !dbg !148
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8*)*)(i32 25, i8* %arrayidx), !dbg !149
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8*)*)(i32 1, i8* %arrayidx), !dbg !149
  store i8 0, i8* %arrayidx, align 1, !dbg !149
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct._IO_FILE**)*)(i32 26, %struct._IO_FILE** %file), !dbg !150
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct._IO_FILE**)*)(i32 1, %struct._IO_FILE** %file), !dbg !150
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %file, align 4, !dbg !150
  %call3 = call i32 @fclose(%struct._IO_FILE* %9), !dbg !151
  ret void, !dbg !152
}
...
entry:
  ...
  %0 = getelementptr inbounds [23 x i8], [23 x i8]* @.str.4, i32 0, i32 0
  call void @read_char_from_file(i8* %0, i8* %arraydecay, i32 1000), !dbg !159
  ret void, !dbg !160
}
...
entry:
  ...
  %p = alloca i8*, align 4
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, %struct.cmd_t**)*)(i32 27, %struct.cmd_t** %cmd.addr)
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr)
  ...
  %0 = getelementptr inbounds [43 x i8], [43 x i8]* @.str.5, i32 0, i32 0
  %call = call i32 (i8*, ...) @printf(i8* %0), !dbg !178
  %arraydecay = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 0, !dbg !179
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct._IO_FILE**)*)(i32 28, %struct._IO_FILE** @stdin), !dbg !181
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct._IO_FILE**)*)(i32 1, %struct._IO_FILE** @stdin), !dbg !181
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 4, !dbg !181
  %call1 = call i8* @fgets(i8* %arraydecay, i32 256, %struct._IO_FILE* %1), !dbg !182
  %tobool = icmp ne i8* %call1, null, !dbg !182
  br i1 %tobool, label %if.end, label %if.then, !dbg !183

if.then:                                          ; preds = %entry
  call void @opdfi_dfi_store_taint(i32 29, i32* %retval), !dbg !184
  call void @opdfi_sandbox_store_check(i32 1, i32* %retval), !dbg !184
...
if.end:                                           ; preds = %entry
  ...
  call void @opdfi_dfi_store_taint(i32 30, i32* %L), !dbg !187
  call void @opdfi_sandbox_store_check(i32 1, i32* %L), !dbg !187
  store i32 %call3, i32* %L, align 4, !dbg !187
  call void @opdfi_dfi_load_checked(i32 31, i32* %L), !dbg !190
  call void @opdfi_sandbox_load_check(i32 1, i32* %L), !dbg !190
  %2 = load i32, i32* %L, align 4, !dbg !190
  %cmp = icmp ugt i32 %2, 0, !dbg !192
  br i1 %cmp, label %land.lhs.true, label %if.end8, !dbg !193

land.lhs.true:                                    ; preds = %if.end
  call void @opdfi_dfi_load_checked(i32 32, i32* %L), !dbg !194
  call void @opdfi_sandbox_load_check(i32 1, i32* %L), !dbg !194
  %3 = load i32, i32* %L, align 4, !dbg !194
  %sub = sub i32 %3, 1, !dbg !195
  %arrayidx = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 %sub, !dbg !196
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8*)*)(i32 33, i8* %arrayidx), !dbg !196
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8*)*)(i32 1, i8* %arrayidx), !dbg !196
  %4 = load i8, i8* %arrayidx, align 1, !dbg !196
  %conv = zext i8 %4 to i32, !dbg !196
  %cmp4 = icmp eq i32 %conv, 10, !dbg !197
  br i1 %cmp4, label %if.then6, label %if.end8, !dbg !198

if.then6:                                         ; preds = %land.lhs.true
  call void @opdfi_dfi_load_checked(i32 34, i32* %L), !dbg !199
  call void @opdfi_sandbox_load_check(i32 1, i32* %L), !dbg !199
  %5 = load i32, i32* %L, align 4, !dbg !199
  %dec = add i32 %5, -1, !dbg !199
  call void @opdfi_dfi_store_taint(i32 35, i32* %L), !dbg !199
  call void @opdfi_sandbox_store_check(i32 1, i32* %L), !dbg !199
  store i32 %dec, i32* %L, align 4, !dbg !199
  %arrayidx7 = getelementptr inbounds [256 x i8], [256 x i8]* %line, i32 0, i32 %dec, !dbg !200
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8*)*)(i32 36, i8* %arrayidx7), !dbg !201
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8*)*)(i32 1, i8* %arrayidx7), !dbg !201
...
if.end8:                                          ; preds = %if.then6, %land.lhs.true, %if.end
  ...
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8**)*)(i32 37, i8** %p), !dbg !203
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !203
  store i8* %arraydecay9, i8** %p, align 4, !dbg !203
  br label %while.cond, !dbg !205

while.cond:                                       ; preds = %while.body, %if.end8
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 38, i8** %p), !dbg !206
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !206
  %6 = load i8*, i8** %p, align 4, !dbg !206
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8*)*)(i32 41, i8* %6), !dbg !207
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8*)*)(i32 1, i8* %6), !dbg !207
  %7 = load i8, i8* %6, align 1, !dbg !207
  %conv10 = zext i8 %7 to i32, !dbg !207
...
land.rhs:                                         ; preds = %while.cond
  ...
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i16**)*)(i32 42, i16** %call12), !dbg !209
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i16**)*)(i32 1, i16** %call12), !dbg !209
  %8 = load i16*, i16** %call12, align 4, !dbg !209
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 43, i8** %p), !dbg !209
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !209
  %9 = load i8*, i8** %p, align 4, !dbg !209
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8*)*)(i32 44, i8* %9), !dbg !209
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8*)*)(i32 1, i8* %9), !dbg !209
  %10 = load i8, i8* %9, align 1, !dbg !209
  %conv13 = zext i8 %10 to i32, !dbg !209
  %arrayidx14 = getelementptr inbounds i16, i16* %8, i32 %conv13, !dbg !209
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i16*)*)(i32 45, i16* %arrayidx14), !dbg !209
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i16*)*)(i32 1, i16* %arrayidx14), !dbg !209
  %11 = load i16, i16* %arrayidx14, align 2, !dbg !209
  %conv15 = zext i16 %11 to i32, !dbg !209
  %and = and i32 %conv15, 8192, !dbg !209
  %tobool16 = icmp ne i32 %and, 0, !dbg !208
  br label %land.end

land.end:                                         ; preds = %land.rhs, %while.cond
  %12 = phi i1 [ false, %while.cond ], [ %tobool16, %land.rhs ], !dbg !210
  br i1 %12, label %while.body, label %while.end, !dbg !205

while.body:                                       ; preds = %land.end
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 39, i8** %p), !dbg !211
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !211
  %13 = load i8*, i8** %p, align 4, !dbg !211
  %incdec.ptr = getelementptr inbounds i8, i8* %13, i32 1, !dbg !211
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8**)*)(i32 40, i8** %p), !dbg !211
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !211
  store i8* %incdec.ptr, i8** %p, align 4, !dbg !211
  br label %while.cond, !dbg !205, !llvm.loop !212

while.end:                                        ; preds = %land.end
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 46, i8** %p), !dbg !215
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !215
  %14 = load i8*, i8** %p, align 4, !dbg !215
  %15 = getelementptr inbounds [5 x i8], [5 x i8]* @.str.6, i32 0, i32 0
  %call17 = call i32 @strncmp(i8* %14, i8* %15, i32 4) #8, !dbg !217
  %cmp18 = icmp eq i32 %call17, 0, !dbg !218
  br i1 %cmp18, label %if.then20, label %if.end21, !dbg !219

if.then20:                                        ; preds = %while.end
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 47, %struct.cmd_t** %cmd.addr), !dbg !220
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !220
  %16 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !220
  %op = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %16, i32 0, i32 1, !dbg !222
  call void @opdfi_dfi_store_taint(i32 7, i32* %op), !dbg !223
  call void @opdfi_sandbox_store_check(i32 1, i32* %op), !dbg !223
  store i32 0, i32* %op, align 4, !dbg !223
  call void @opdfi_dfi_store_taint(i32 48, i32* %retval), !dbg !224
  call void @opdfi_sandbox_store_check(i32 1, i32* %retval), !dbg !224
  store i32 0, i32* %retval, align 4, !dbg !224
  br label %return, !dbg !224

if.end21:                                         ; preds = %while.end
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 49, i8** %p), !dbg !225
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !225
  %17 = load i8*, i8** %p, align 4, !dbg !225
  %18 = getelementptr inbounds [5 x i8], [5 x i8]* @.str.7, i32 0, i32 0
  %call22 = call i32 @strncmp(i8* %17, i8* %18, i32 4) #8, !dbg !227
  %cmp23 = icmp eq i32 %call22, 0, !dbg !228
  br i1 %cmp23, label %if.then25, label %if.end57, !dbg !229

if.then25:                                        ; preds = %if.end21
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 50, i8** %p), !dbg !230
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !230
  %19 = load i8*, i8** %p, align 4, !dbg !230
  %add.ptr = getelementptr inbounds i8, i8* %19, i32 4, !dbg !230
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8**)*)(i32 51, i8** %p), !dbg !230
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !230
  store i8* %add.ptr, i8** %p, align 4, !dbg !230
  br label %while.cond26, !dbg !232

while.cond26:                                     ; preds = %while.body37, %if.then25
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 52, i8** %p), !dbg !233
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !233
  %20 = load i8*, i8** %p, align 4, !dbg !233
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8*)*)(i32 55, i8* %20), !dbg !234
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8*)*)(i32 1, i8* %20), !dbg !234
  %21 = load i8, i8* %20, align 1, !dbg !234
  %conv27 = zext i8 %21 to i32, !dbg !234
...
land.rhs29:                                       ; preds = %while.cond26
  ...
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i16**)*)(i32 56, i16** %call30), !dbg !236
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i16**)*)(i32 1, i16** %call30), !dbg !236
  %22 = load i16*, i16** %call30, align 4, !dbg !236
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 57, i8** %p), !dbg !236
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !236
  %23 = load i8*, i8** %p, align 4, !dbg !236
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8*)*)(i32 58, i8* %23), !dbg !236
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8*)*)(i32 1, i8* %23), !dbg !236
  %24 = load i8, i8* %23, align 1, !dbg !236
  %conv31 = zext i8 %24 to i32, !dbg !236
  %arrayidx32 = getelementptr inbounds i16, i16* %22, i32 %conv31, !dbg !236
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i16*)*)(i32 59, i16* %arrayidx32), !dbg !236
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i16*)*)(i32 1, i16* %arrayidx32), !dbg !236
  %25 = load i16, i16* %arrayidx32, align 2, !dbg !236
  %conv33 = zext i16 %25 to i32, !dbg !236
  %and34 = and i32 %conv33, 8192, !dbg !236
  %tobool35 = icmp ne i32 %and34, 0, !dbg !235
  br label %land.end36

land.end36:                                       ; preds = %land.rhs29, %while.cond26
  %26 = phi i1 [ false, %while.cond26 ], [ %tobool35, %land.rhs29 ], !dbg !237
  br i1 %26, label %while.body37, label %while.end39, !dbg !232

while.body37:                                     ; preds = %land.end36
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 53, i8** %p), !dbg !238
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !238
  %27 = load i8*, i8** %p, align 4, !dbg !238
  %incdec.ptr38 = getelementptr inbounds i8, i8* %27, i32 1, !dbg !238
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8**)*)(i32 54, i8** %p), !dbg !238
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !238
  store i8* %incdec.ptr38, i8** %p, align 4, !dbg !238
  br label %while.cond26, !dbg !232, !llvm.loop !239

while.end39:                                      ; preds = %land.end36
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 60, %struct.cmd_t** %cmd.addr), !dbg !241
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !241
  %28 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !241
  %op40 = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %28, i32 0, i32 1, !dbg !242
  call void @opdfi_dfi_store_taint(i32 6, i32* %op40), !dbg !243
  call void @opdfi_sandbox_store_check(i32 1, i32* %op40), !dbg !243
  store i32 1, i32* %op40, align 4, !dbg !243
  %29 = getelementptr inbounds [22 x i8], [22 x i8]* @.str.8, i32 0, i32 0
  %call41 = call i32 (i8*, ...) @printf(i8* %29), !dbg !244
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 61, i8** %p), !dbg !245
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !245
  %30 = load i8*, i8** %p, align 4, !dbg !245
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8*)*)(i32 62, i8* %30), !dbg !247
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8*)*)(i32 1, i8* %30), !dbg !247
  %31 = load i8, i8* %30, align 1, !dbg !247
  %conv42 = zext i8 %31 to i32, !dbg !247
  %cmp43 = icmp eq i32 %conv42, 0, !dbg !248
  br i1 %cmp43, label %if.then45, label %if.else, !dbg !249

if.then45:                                        ; preds = %while.end39
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 63, %struct.cmd_t** %cmd.addr), !dbg !250
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !250
  %32 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !250
  %p_size = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %32, i32 0, i32 0, !dbg !252
  call void @opdfi_dfi_store_taint(i32 64, i32* %p_size), !dbg !253
  call void @opdfi_sandbox_store_check(i32 1, i32* %p_size), !dbg !253
  store i32 0, i32* %p_size, align 4, !dbg !253
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 65, %struct.cmd_t** %cmd.addr), !dbg !254
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !254
  %33 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !254
  %param = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %33, i32 0, i32 2, !dbg !255
  %arrayidx46 = getelementptr inbounds [1 x i8], [1 x i8]* %param, i32 0, i32 0, !dbg !254
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8*)*)(i32 66, i8* %arrayidx46), !dbg !256
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8*)*)(i32 1, i8* %arrayidx46), !dbg !256
  store i8 0, i8* %arrayidx46, align 4, !dbg !256
  br label %if.end56, !dbg !257

if.else:                                          ; preds = %while.end39
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 67, %struct.cmd_t** %cmd.addr), !dbg !258
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !258
  %34 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !258
  %param47 = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %34, i32 0, i32 2, !dbg !260
  %arraydecay48 = getelementptr inbounds [1 x i8], [1 x i8]* %param47, i32 0, i32 0, !dbg !258
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 68, i8** %p), !dbg !261
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !261
  %35 = load i8*, i8** %p, align 4, !dbg !261
  %call49 = call i8* @strncpy(i8* %arraydecay48, i8* %35, i32 0) #10, !dbg !262
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 69, %struct.cmd_t** %cmd.addr), !dbg !263
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !263
  %36 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !263
  %param50 = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %36, i32 0, i32 2, !dbg !264
  %arrayidx51 = getelementptr inbounds [1 x i8], [1 x i8]* %param50, i32 0, i32 0, !dbg !263
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8*)*)(i32 70, i8* %arrayidx51), !dbg !265
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8*)*)(i32 1, i8* %arrayidx51), !dbg !265
  store i8 0, i8* %arrayidx51, align 4, !dbg !265
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 71, %struct.cmd_t** %cmd.addr), !dbg !266
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !266
  %37 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !266
  %param52 = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %37, i32 0, i32 2, !dbg !267
  ...
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 72, %struct.cmd_t** %cmd.addr), !dbg !269
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !269
  %38 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !269
  %p_size55 = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %38, i32 0, i32 0, !dbg !270
  call void @opdfi_dfi_store_taint(i32 73, i32* %p_size55), !dbg !271
  call void @opdfi_sandbox_store_check(i32 1, i32* %p_size55), !dbg !271
  store i32 %call54, i32* %p_size55, align 4, !dbg !271
  br label %if.end56

if.end56:                                         ; preds = %if.else, %if.then45
  call void @opdfi_dfi_store_taint(i32 74, i32* %retval), !dbg !272
  call void @opdfi_sandbox_store_check(i32 1, i32* %retval), !dbg !272
  store i32 3, i32* %retval, align 4, !dbg !272
  br label %return, !dbg !272

if.end57:                                         ; preds = %if.end21
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 75, %struct.cmd_t** %cmd.addr), !dbg !273
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !273
  %39 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !273
  %param58 = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %39, i32 0, i32 2, !dbg !274
  %arraydecay59 = getelementptr inbounds [1 x i8], [1 x i8]* %param58, i32 0, i32 0, !dbg !273
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 76, i8** %p), !dbg !275
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %p), !dbg !275
  %40 = load i8*, i8** %p, align 4, !dbg !275
  %call60 = call i8* @strncpy(i8* %arraydecay59, i8* %40, i32 0) #10, !dbg !276
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 77, %struct.cmd_t** %cmd.addr), !dbg !277
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !277
  %41 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !277
  %param61 = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %41, i32 0, i32 2, !dbg !278
  %arrayidx62 = getelementptr inbounds [1 x i8], [1 x i8]* %param61, i32 0, i32 0, !dbg !277
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8*)*)(i32 78, i8* %arrayidx62), !dbg !279
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8*)*)(i32 1, i8* %arrayidx62), !dbg !279
  store i8 0, i8* %arrayidx62, align 4, !dbg !279
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 79, %struct.cmd_t** %cmd.addr), !dbg !280
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !280
  %42 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !280
  %op63 = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %42, i32 0, i32 1, !dbg !281
  call void @opdfi_dfi_store_taint(i32 8, i32* %op63), !dbg !282
  call void @opdfi_sandbox_store_check(i32 1, i32* %op63), !dbg !282
  store i32 1, i32* %op63, align 4, !dbg !282
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 80, %struct.cmd_t** %cmd.addr), !dbg !283
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !283
  %43 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !283
  %param64 = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %43, i32 0, i32 2, !dbg !284
  ...
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, %struct.cmd_t**)*)(i32 81, %struct.cmd_t** %cmd.addr), !dbg !286
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, %struct.cmd_t**)*)(i32 1, %struct.cmd_t** %cmd.addr), !dbg !286
  %44 = load %struct.cmd_t*, %struct.cmd_t** %cmd.addr, align 4, !dbg !286
  %p_size67 = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %44, i32 0, i32 0, !dbg !287
  call void @opdfi_dfi_store_taint(i32 82, i32* %p_size67), !dbg !288
  call void @opdfi_sandbox_store_check(i32 1, i32* %p_size67), !dbg !288
  store i32 %call66, i32* %p_size67, align 4, !dbg !288
  call void @opdfi_dfi_store_taint(i32 83, i32* %retval), !dbg !289
  call void @opdfi_sandbox_store_check(i32 1, i32* %retval), !dbg !289
  store i32 3, i32* %retval, align 4, !dbg !289
  br label %return, !dbg !289

return:                                           ; preds = %if.end57, %if.end56, %if.then20, %if.then
  call void @opdfi_dfi_load_checked(i32 84, i32* %retval), !dbg !290
  call void @opdfi_sandbox_load_check(i32 1, i32* %retval), !dbg !290
  %45 = load i32, i32* %retval, align 4, !dbg !290
  ret i32 %45, !dbg !290
}
...
entry:
  ...
  call void @opdfi_dfi_store_taint(i32 85, i32* %dynamic_size), !dbg !294
  call void @opdfi_sandbox_store_check(i32 1, i32* %dynamic_size), !dbg !294
  store volatile i32 4, i32* %dynamic_size, align 4, !dbg !294
  call void @opdfi_dfi_load_checked(i32 86, i32* %dynamic_size), !dbg !295
  call void @opdfi_sandbox_load_check(i32 1, i32* %dynamic_size), !dbg !295
  %0 = load volatile i32, i32* %dynamic_size, align 4, !dbg !295
  %1 = call i8* @llvm.stacksave(), !dbg !296
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8**)*)(i32 87, i8** %saved_stack), !dbg !296
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8**)*)(i32 1, i8** %saved_stack), !dbg !296
  store i8* %1, i8** %saved_stack, align 4, !dbg !296
  %vla = alloca i8, i32 %0, align 1, !dbg !296
  call void @opdfi_dfi_store_taint(i32 88, i32* %__vla_expr0), !dbg !296
  call void @opdfi_sandbox_store_check(i32 1, i32* %__vla_expr0), !dbg !296
  ...
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i8*)*)(i32 89, i8* %arrayidx), !dbg !305
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i8*)*)(i32 1, i8* %arrayidx), !dbg !305
  ...
  call void @opdfi_dfi_store_taint(i32 90, i32* %st), !dbg !307
  call void @opdfi_sandbox_store_check(i32 1, i32* %st), !dbg !307
  ...
  %2 = getelementptr inbounds [19 x i8], [19 x i8]* @.str.9, i32 0, i32 0
  %3 = getelementptr inbounds [17 x i8], [17 x i8]* @.str.10, i32 0, i32 0
  call void @llvm.var.annotation(i8* %cmd1, i8* %2, i8* %3, i32 127, i8* null), !dbg !310
...
while.body:                                       ; preds = %while.cond
  ...
  call void @opdfi_dfi_store_taint(i32 91, i32* %st), !dbg !317
  call void @opdfi_sandbox_store_check(i32 1, i32* %st), !dbg !317
...
if.then:                                          ; preds = %while.body
  ...
  call void @opdfi_dfi_load_checked(i32 92, i32* %st), !dbg !321
  call void @opdfi_sandbox_load_check(i32 1, i32* %st), !dbg !321
  %4 = load i32, i32* %st, align 4, !dbg !321
  %cmp = icmp sgt i32 %4, 2, !dbg !323
...
if.then2:                                         ; preds = %if.then
  ...
  call void @opdfi_dfi_load_checked(i32 5, i32* %op), !dbg !325
  call void @opdfi_sandbox_load_check(i32 1, i32* %op), !dbg !325
  %5 = load i32, i32* %op, align 4, !dbg !325
  %call3 = call i32 (i32, i8*)* @get_op_func(i32 %5), !dbg !327
  call void bitcast (void (i32, i32*)* @opdfi_dfi_store_taint to void (i32, i32 (i32, i8*)**)*)(i32 93, i32 (i32, i8*)** %op_func), !dbg !328
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_store_check to void (i32, i32 (i32, i8*)**)*)(i32 1, i32 (i32, i8*)** %op_func), !dbg !328
  store i32 (i32, i8*)* %call3, i32 (i32, i8*)** %op_func, align 4, !dbg !328
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i32 (i32, i8*)**)*)(i32 94, i32 (i32, i8*)** %op_func), !dbg !329
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i32 (i32, i8*)**)*)(i32 1, i32 (i32, i8*)** %op_func), !dbg !329
  %6 = load i32 (i32, i8*)*, i32 (i32, i8*)** %op_func, align 4, !dbg !329
  %p_size = getelementptr inbounds %struct.cmd_t, %struct.cmd_t* %cmd, i32 0, i32 0, !dbg !330
  call void @opdfi_dfi_load_checked(i32 95, i32* %p_size), !dbg !330
  call void @opdfi_sandbox_load_check(i32 1, i32* %p_size), !dbg !330
  %7 = load i32, i32* %p_size, align 4, !dbg !330
  ...
  %call4 = call i32 %6(i32 %7, i8* %arraydecay), !dbg !333
  br label %if.end, !dbg !334

if.else:                                          ; preds = %if.then
  call void @opdfi_dfi_load_checked(i32 96, i32* %st), !dbg !335
  call void @opdfi_sandbox_load_check(i32 1, i32* %st), !dbg !335
  %8 = load i32, i32* %st, align 4, !dbg !335
  %9 = getelementptr inbounds [45 x i8], [45 x i8]* @.str.11, i32 0, i32 0
  %call5 = call i32 (i8*, ...) @printf(i8* %9, i32 %8), !dbg !337
  br label %if.end
...
if.else6:                                         ; preds = %while.body
  %10 = getelementptr inbounds [39 x i8], [39 x i8]* @.str.12, i32 0, i32 0
  %call7 = call i32 (i8*, ...) @printf(i8* %10), !dbg !339
...
while.end:                                        ; preds = %if.else6
  call void bitcast (void (i32, i32*)* @opdfi_dfi_load_checked to void (i32, i8**)*)(i32 97, i8** %saved_stack), !dbg !345
  call void bitcast (void (i32, i32*)* @opdfi_sandbox_load_check to void (i32, i8**)*)(i32 1, i8** %saved_stack), !dbg !345
  %11 = load i8*, i8** %saved_stack, align 4, !dbg !345
  call void @llvm.stackrestore(i8* %11), !dbg !345
  ret void, !dbg !345
}
...
entry:
  %retval = alloca i32, align 4
  call void @opdfi_dfi_store_taint(i32 98, i32* %retval)
  call void @opdfi_sandbox_store_check(i32 1, i32* %retval)
  store i32 0, i32* %retval, align 4
  %0 = getelementptr inbounds [58 x i8], [58 x i8]* @.str.13, i32 0, i32 0
  %call = call i32 (i8*, ...) @printf(i8* %0), !dbg !349
  call void @main_looper(), !dbg !350
  %1 = getelementptr inbounds [26 x i8], [26 x i8]* @.str.14, i32 0, i32 0
  %call1 = call i32 (i8*, ...) @printf(i8* %1), !dbg !351
  ret i32 0, !dbg !352
}

declare void @opdfi_dfi_store_taint(i32, i32*)

declare void @opdfi_sandbox_store_check(i32, i32*)

declare void @opdfi_dfi_load_checked(i32, i32*)

declare void @opdfi_sandbox_load_check(i32, i32*)
